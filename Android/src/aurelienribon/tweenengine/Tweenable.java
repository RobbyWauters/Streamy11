...
public interface Tweenable {
	 ...
	 * @param startValues A table which should be modified by this method.
	 * @return The count of tweened parameters.
	 */
	public int getTweenValues(int tweenType, float[] startValues);
	 ...
	 */
	public void onTweenUpdated(int tweenType, float[] newValue);
}
